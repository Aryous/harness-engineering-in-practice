...
![harness components](/blog/skill-issue/harness-components.png) *Image from [Viv's post](https://blog.langchain.com/the-anatomy-of-an-agent-harness/)*
...
![working backwards from what models can't do natively](/blog/skill-issue/backwards.png) *Image from [Viv's post](https://blog.langchain.com/the-anatomy-of-an-agent-harness/)*
